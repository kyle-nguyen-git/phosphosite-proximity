...
- `manuscript/preprint_draft_v1.md` and `.pdf` — the frozen single-author review PDF; and
  `../phase0_calibration_preprint_humanized_v2.md`, the current two-author manuscript that would
  actually be posted. These differ in authorship, affiliation, and figure lineage, not in any number;
  `NUMBERS.md` Section 17 explains which figures belong to which;
- `phase0_5/ANALYSIS_PROVENANCE.md`;
- `results/cohort_disposition.csv`;
- `src/01_build_sites.py`, `src/03_analysis.py`, and `phase0_5/src/02_phase0_5_analysis.py`;
...
- Release-candidate archive SHA-256: `[required]`
