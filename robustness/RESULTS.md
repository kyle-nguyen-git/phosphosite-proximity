...
Raw S-scores and AlphaFold pair PAE are complete for both arms. No retained primary or inclusive strain carries a Supplementary Data 8 WGS or scar-control-correlation flag. `results/robustness_statistics.json` is machine-readable; `results/verification_report.json` records executable release checks.
