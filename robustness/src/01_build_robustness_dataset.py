"""Build the enriched the robustness analysis analysis table.
...
def main() -> None:
    ...
    output_path = RESULTS / "robustness_analysis.csv"
    ...
    print(f"the robustness analysis table: {len(enriched)} sites / {enriched.acc.nunique()} proteins")
