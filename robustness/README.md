# the robustness analysis Release Package
...
- `results/robustness_publication_data.csv` — one row per analyzed phosphosite.
- `results/robustness_statistics.json` — machine-readable results.
- `results/robustness_supplement.xlsx` — formatted tables, analysis data, source manifest, and mismatch audit.
...
- `results/robustness_robustness_summary.{pdf,png}` — one-page summary figure.
