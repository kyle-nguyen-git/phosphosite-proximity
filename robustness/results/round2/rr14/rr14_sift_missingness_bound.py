...
spec = importlib.util.spec_from_file_location(
    "p05", ROOT / "robustness" / "src" / "02_robustness_analysis.py"
)
...
all_data = pd.read_csv(ROOT / "robustness" / "results" / "robustness_analysis.csv")
...
frozen = json.loads((ROOT / "robustness" / "results" / "robustness_statistics.json").read_text())
