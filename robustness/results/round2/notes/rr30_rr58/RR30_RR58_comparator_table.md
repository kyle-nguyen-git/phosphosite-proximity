...
- Estimators loaded from `robustness/src/02_robustness_analysis.py` (`auc_from_ranks`,
...
- Cohort: `robustness/results/robustness_analysis.csv` filtered on
...
- One unavoidable side effect to disclose: importing the frozen analysis module caused CPython to
  refresh `robustness/src/__pycache__/02_robustness_analysis.cpython-312.pyc`. That is an automatic
  bytecode cache, regenerated deterministically from unchanged source. The source is byte-identical
  (`02_robustness_analysis.py` sha256 `cba6d8c7b440c967096c57a66f8c2d419a358e4ba9750ea21bd2c4461c87aa49`,
  ...
  `robustness/results/robustness_analysis.csv` sha256 `8437294a8a94d2cf280e4811cbd2221326da4f250728375a9a06f1f8b760b801`.
