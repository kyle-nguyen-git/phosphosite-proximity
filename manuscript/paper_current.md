...
| Difference in AUC, sequence separation minus distance, paired | Human, reporter | 1,470 | +0.066 | −0.001 to +0.131 | Post hoc; contains zero, as does every other paired difference |
