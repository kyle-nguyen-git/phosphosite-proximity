...
OUTPUT = RESULTS / "phase0_5_supplement.xlsx"
...
def build_logistic_diagnostics() -> None:
    ...
    frames = {
        "exclude_annotation_coincident": pd.read_csv(RESULTS / "phase0_5_primary_analysis.csv"),
        "include_annotation_coincident": pd.read_csv(
            RESULTS / "phase0_5_inclusive_sensitivity_analysis.csv"
        ),
    }
    rows = []
...
def add_summary(workbook: Workbook, numbers_text: str) -> None:
    ...
    sheet["A1"] = "Phase 0.5 — two-arm structural-distance calibration"
...
def build_workbook() -> None:
    ...
    workbook = Workbook()
    workbook.properties.title = "Phase 0.5 structural-distance calibration supplement"
