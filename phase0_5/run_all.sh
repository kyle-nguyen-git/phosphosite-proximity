...
export MPLCONFIGDIR="${TMPDIR:-/tmp}/phase0_5_matplotlib"
...
"$PYTHON_BIN" "$PHASE05_DIR/src/01_build_phase0_5_dataset.py"
"$PYTHON_BIN" "$PHASE05_DIR/src/02_phase0_5_analysis.py"
"$PYTHON_BIN" "$PHASE05_DIR/src/03_phase0_5_figure.py"
