...
Frozen-tree rules honoured here:
  ...
  * the three frozen hashes are checked before any computation and the run aborts on
    mismatch;
  * AUC and the bootstrap are loaded from phase0_5/src/02_phase0_5_analysis.py, not
...
Replicate aggregation follows phase0_5/src/01_build_phase0_5_dataset.py
...
OUT = HERE
# phase0_calibration/ is the nearest ancestor holding NUMBERS.md, so this script keeps
...
def main() -> None:
    ...
    enriched = pd.read_csv(ROOT / "phase0_5" / "results" / "phase0_5_analysis.csv")
    ...
    summary = {
        ...
        "conventions": {
            ...
            "replicate_aggregation": (
                ...
                "(phase0_5/src/01_build_phase0_5_dataset.py aggregate_raw_scores; "
